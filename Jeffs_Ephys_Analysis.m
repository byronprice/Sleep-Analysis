...
earlyCutOff = earlyCutOff*3600;
lateCutOff = lateCutOff*3600;
...
for ii=1:length(dates)
    ...
    for jj=1:numFiles
        ...
        for kk = 1:numCombos 
            ...
            subplot(numRows,2,plotcount)
            plotcount = plotcount+1;
            fspectro = squeeze(finalSpectrogram(kk,:,:));
...
%         numFreqs = size(finalSpectrogram,2);
        fspectro = squeeze(finalSpectrogram(1,:,:));
